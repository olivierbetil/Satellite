...
/* USER CODE BEGIN Header_SPI_App */
/**
* @brief Function implementing the Task_SPI thread.
* @param argument: Not used
* @retval None
*/
...
void SPI_App(void const * argument)
{
  ...
  /* USER CODE END SPI_App */
}

/* USER CODE BEGIN Header_UART_App */
/**
