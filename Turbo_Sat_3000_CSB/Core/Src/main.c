...
osThreadId Task_SPI_RxHandle;
osThreadId Task_UART_SendHandle;
osThreadId Task_UART_RecieHandle;
osThreadId Task_SPI_TxHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_Idle_App */
/**
...
/* USER CODE BEGIN Header_SPI_Rx_App */
/**
* @brief Function implementing the Task_SPI_Rx thread.
* @param argument: Not used
* @retval None
*/
...
void SPI_Rx_App(void const * argument)
{
  ...
  /* USER CODE END SPI_Rx_App */
}

/* USER CODE BEGIN Header_UART_Send_App */
/**
* @brief Function implementing the Task_UART_Send thread.
* @param argument: Not used
* @retval None
*/
...
void UART_Send_App(void const * argument)
{
  ...
  /* USER CODE END UART_Send_App */
}

/* USER CODE BEGIN Header_UART_Recie_App */
/**
* @brief Function implementing the Task_UART_Recie thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_SPI_Tx_App */
/**
* @brief Function implementing the Task_SPI_Tx thread.
* @param argument: Not used
* @retval None
*/
