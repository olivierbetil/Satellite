...
typedef enum {
	TS_TEMP_UNIT_FARENHEIT, TS_TEMP_UNIT_CELCIUS
} TS_temp_unit_e;
 ...
 */
typedef enum {
	IOE_OK = 0, IOE_FAILURE, IOE_TIMEOUT, PARAM_ERROR, IOE1_NOT_OPERATIONAL,
} IOE_Status_TypDef;
...
#define IOE_DMA_TX_TCFLAG                DMA_FLAG_TCIF2_6
#define IOE_DMA_RX_TCFLAG                DMA_FLAG_TCIF0_4
