...
TM_USB_Result_t TM_USB_InitFS(void) {
	...
	BSP_GPIO_PinCfg(GPIOA, GPIO_PIN_9 | GPIO_PIN_11 | GPIO_PIN_12, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL, GPIO_SPEED_FAST, GPIO_AF10_OTG_FS);
	
	/* Init ID pin */
	BSP_GPIO_PinCfg(GPIOA, GPIO_PIN_10, GPIO_MODE_OUTPUT_OD, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF10_OTG_FS);
